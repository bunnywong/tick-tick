...
$options = array(
    ...
    'slider' => array(
        'type' => 'box',
        'title' => esc_html__('Slider', 'naslaan'),
        'options' => array(
			...
			'slider_options_group' => array(
			    ...
			    'options' => array(
					...
					'slider_container' => array(
						...
						'desc' => false,
						'value' => array(
							'slider_container_type' => 'full',
						),
						'picker' => array(
							'slider_container_type' => array(
								'type'  => 'radio',
							    'label' => esc_html__('Slider Container', 'naslaan' ),
							    'choices' => array(
					...
					'slider_shortcode' => array(
						'label' => esc_html__( 'Slider', 'naslaan' ),
						'type' => 'text',
						'value' => '',
						'desc' => esc_html__( 'Place "Revolution Slider" shortcode to show the slider', 'naslaan' ),
					),
