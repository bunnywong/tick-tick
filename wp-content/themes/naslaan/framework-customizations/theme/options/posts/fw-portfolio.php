...
$options = array(
    ...
    'page_options' => array(
        ...
        'options' => array(
			...
			'portfolio_post_layout' => array(
			    'type'  => 'select',
			    'value' => 'full_width',
			    'label' => '',
			    'choices' => array(
			    	'full_width' => esc_html__('Full Width', 'naslaan' ),
			        'sidebar' => esc_html__('Sidebar', 'naslaan' ),
			    ),
			    'label' => esc_html__('Post Layouts', 'naslaan' ),
			    'no-validate' => false,
			),
			...
			'portfolio_post_type' => array(
			    ...
			    'label' => '',
			    'choices' => array(
			    	'gallery' => esc_html__('Gallery', 'naslaan' ),
			        'slider' => esc_html__('Slider', 'naslaan' ),
			    ),
			    'label' => esc_html__('Post Type', 'naslaan' ),
			    'no-validate' => false,
			),
