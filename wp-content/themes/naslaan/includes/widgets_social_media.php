<?php
$widget_social_media_type = $forrst_switch = $forrst_url = $dribbble_switch = $dribbble_url =  $twitter_switch = $twitter_url =$flickr_switch = $flickr_url = $twitter2_switch = $twitter2_url = $facebook_switch = $facebook_url = $skype_switch = $skype_url = $digg_switch = $digg_url = $google_switch = $google_url = $html5_switch = $html5_url = $linkedin_switch = $linkedin_url = $lastfm_switch = $lastfm_url = $vimeo_switch = $vimeo_url = $yahoo_switch = $yahoo_url = $tumblr_switch = $tumblr_url = $apple_switch = $apple_url = $windows_switch = $windows_url = $youtube_switch = $youtube_url = $delicious_switch = $delicious_url = $rss_switch = $rss_url = $picasa_switch = $picasa_url = $deviantart_switch = $deviantart_url = $whatsapp_switch = $whatsapp_url = $snapchat_switch = $snapchat_url = $blogger_switch = $blogger_url = $wordpress_switch = $wordpress_url = $amazon_switch = $amazon_url = $appstore_switch = $appstore_url = $paypal_switch = $paypal_url = $myspace_switch = $myspace_url = $dropbox_switch = $dropbox_url = $windows8_switch = $windows8_url = $pinterest_switch = $pinterest_url = $soundcloud_switch = $soundcloud_url = $google_drive_switch = $google_drive_url = $android_switch = $android_url = $behance_switch = $behance_url = $instagram_switch = $instagram_url = $ebay_switch = $ebay_url = $google_plus_switch = $google_plus_url = $github_switch = $github_url = $stackoverflow_switch = $stackoverflow_url = $spotify_switch = $spotify_url = $stumbleupon_switch = $stumbleupon_url = $visa_switch = $visa_url = $mastercard_switch = $mastercard_url = $amex_switch = $amex_url = $ios_switch = $ios_url = $osx_switch = $osx_url = $evernote_switch = $evernote_url = $yelp_switch = $yelp_url = $yelp2_switch = $yelp2_url = $medium_switch = $medium_url = $slack_switch = $slack_url = $vine_switch = $vine_url = $edge_switch = $edge_url = $outlook_switch = $outlook_url = $pencilcase_switch = $pencilcase_url = $play_switch = $play_url = $icloud_switch = $icloud_url = $forrst_switch_1 = $forrst_url_1 = $dribbble_switch_1 = $dribbble_url_1 =  $twitter_switch_1 = $twitter_url_1 =$flickr_switch_1 = $flickr_url_1 = $twitter2_switch_1 = $twitter2_url_1 = $facebook_switch_1 = $facebook_url_1 = $skype_switch_1 = $skype_url_1 = $digg_switch_1 = $digg_url_1 = $google_switch_1 = $google_url_1 = $html5_switch_1 = $html5_url_1 = $linkedin_switch_1 = $linkedin_url_1 = $lastfm_switch_1 = $lastfm_url_1 = $vimeo_switch_1 = $vimeo_url_1 = $yahoo_switch_1 = $yahoo_url_1 = $tumblr_switch_1 = $tumblr_url_1 = $apple_switch_1 = $apple_url_1 = $windows_switch_1 = $windows_url_1 = $youtube_switch_1 = $youtube_url_1 = $delicious_switch_1 = $delicious_url_1 = $rss_switch_1 = $rss_url_1 = $picasa_switch_1 = $picasa_url_1 = $deviantart_switch_1 = $deviantart_url_1 = $whatsapp_switch_1 = $whatsapp_url_1 = $snapchat_switch_1 = $snapchat_url_1 = $blogger_switch_1 = $blogger_url_1 = $wordpress_switch_1 = $wordpress_url_1 = $amazon_switch_1 = $amazon_url_1 = $appstore_switch_1 = $appstore_url_1 = $paypal_switch_1 = $paypal_url_1 = $myspace_switch_1 = $myspace_url_1 = $dropbox_switch_1 = $dropbox_url_1 = $windows8_switch_1 = $windows8_url_1 = $pinterest_switch_1 = $pinterest_url_1 = $soundcloud_switch_1 = $soundcloud_url_1 = $google_drive_switch_1 = $google_drive_url_1 = $android_switch_1 = $android_url_1 = $behance_switch_1 = $behance_url_1 = $instagram_switch_1 = $instagram_url_1 = $ebay_switch_1 = $ebay_url_1 = $google_plus_switch_1 = $google_plus_url_1 = $github_switch_1 = $github_url_1 = $stackoverflow_switch_1 = $stackoverflow_url_1 = $spotify_switch_1 = $spotify_url_1 = $stumbleupon_switch_1 = $stumbleupon_url_1 = $visa_switch_1 = $visa_url_1 = $mastercard_switch_1 = $mastercard_url_1 = $amex_switch_1 = $amex_url_1 = $ios_switch_1 = $ios_url_1 = $osx_switch_1 = $osx_url_1 = $evernote_switch_1 = $evernote_url_1 = $yelp_switch_1 = $yelp_url_1 = $yelp2_switch_1 = $yelp2_url_1 = $medium_switch_1 = $medium_url_1 = $slack_switch_1 = $slack_url_1 = $vine_switch_1 = $vine_url_1 = $edge_switch_1 = $edge_url_1 = $outlook_switch_1 = $outlook_url_1 = $pencilcase_switch_1 = $pencilcase_url_1 = $play_switch_1 = $play_url_1 = $icloud_switch_1 = $icloud_url_1 =$social_media_btn_visibility = '';


	if( naslaan_helpers::naslaan_unyson_check() ) {
	
		$widget_social_media_type = fw_get_db_settings_option('widget_social_media_type');
	
		$forrst_switch = fw_get_db_settings_option('widget_social_media_forrst/forrst_switch');
		$forrst_url = fw_get_db_settings_option('widget_social_media_forrst/enabled/forrst_url');
		
		$dribbble_switch = fw_get_db_settings_option('widget_social_media_dribbble/dribbble_switch');
		$dribbble_url = fw_get_db_settings_option('widget_social_media_dribbble/enabled/dribbble_url');
		
		$twitter_switch = fw_get_db_settings_option('widget_social_media_twitter/twitter_switch');
		$twitter_url = fw_get_db_settings_option('widget_social_media_twitter/enabled/twitter_url');
		
		$flickr_switch = fw_get_db_settings_option('widget_social_media_flickr/flickr_switch');
		$flickr_url = fw_get_db_settings_option('widget_social_media_flickr/enabled/flickr_url');
		
		$twitter2_switch = fw_get_db_settings_option('widget_social_media_twitter2/twitter2_switch');
		$twitter2_url = fw_get_db_settings_option('widget_social_media_twitter2/enabled/twitter2_url');
		
		$facebook_switch = fw_get_db_settings_option('widget_social_media_facebook/facebook_switch');
		$facebook_url = fw_get_db_settings_option('widget_social_media_facebook/enabled/facebook_url');
		
		$skype_switch = fw_get_db_settings_option('widget_social_media_skype/skype_switch');
		$skype_url = fw_get_db_settings_option('widget_social_media_skype/enabled/skype_url');
		
		$digg_switch = fw_get_db_settings_option('widget_social_media_digg/digg_switch');
		$digg_url = fw_get_db_settings_option('widget_social_media_digg/enabled/digg_url');
		
		$google_switch = fw_get_db_settings_option('widget_social_media_google/google_switch');
		$google_url = fw_get_db_settings_option('widget_social_media_google/enabled/google_url');
		
		$html5_switch = fw_get_db_settings_option('widget_social_media_html5/html5_switch');
		$html5_url = fw_get_db_settings_option('widget_social_media_html5/enabled/html5_url');
		
		$linkedin_switch = fw_get_db_settings_option('widget_social_media_linkedin/linkedin_switch');
		$linkedin_url = fw_get_db_settings_option('widget_social_media_linkedin/enabled/linkedin_url');
		
		$lastfm_switch = fw_get_db_settings_option('widget_social_media_lastfm/lastfm_switch');
		$lastfm_url = fw_get_db_settings_option('widget_social_media_lastfm/enabled/lastfm_url');
		
		$vimeo_switch = fw_get_db_settings_option('widget_social_media_vimeo/vimeo_switch');
		$vimeo_url = fw_get_db_settings_option('widget_social_media_vimeo/enabled/vimeo_url');
		
		$yahoo_switch = fw_get_db_settings_option('widget_social_media_yahoo/yahoo_switch');
		$yahoo_url = fw_get_db_settings_option('widget_social_media_yahoo/enabled/yahoo_url');
		
		$tumblr_switch = fw_get_db_settings_option('widget_social_media_tumblr/tumblr_switch');
		$tumblr_url = fw_get_db_settings_option('widget_social_media_tumblr/enabled/tumblr_url');
		
		$apple_switch = fw_get_db_settings_option('widget_social_media_apple/apple_switch');
		$apple_url = fw_get_db_settings_option('widget_social_media_apple/enabled/apple_url');
		
		$windows_switch = fw_get_db_settings_option('widget_social_media_windows/windows_switch');
		$windows_url = fw_get_db_settings_option('widget_social_media_windows/enabled/windows_url');
		
		$youtube_switch = fw_get_db_settings_option('widget_social_media_youtube/youtube_switch');
		$youtube_url = fw_get_db_settings_option('widget_social_media_youtube/enabled/youtube_url');
		
		$delicious_switch = fw_get_db_settings_option('widget_social_media_delicious/delicious_switch');
		$delicious_url = fw_get_db_settings_option('widget_social_media_delicious/enabled/delicious_url');
		
		$rss_switch = fw_get_db_settings_option('widget_social_media_rss/rss_switch');
		$rss_url = fw_get_db_settings_option('widget_social_media_rss/enabled/rss_url');
		
		$picasa_switch = fw_get_db_settings_option('widget_social_media_picasa/picasa_switch');
		$picasa_url = fw_get_db_settings_option('widget_social_media_picasa/enabled/picasa_url');
		
		$deviantart_switch = fw_get_db_settings_option('widget_social_media_deviantart/deviantart_switch');
		$deviantart_url = fw_get_db_settings_option('widget_social_media_deviantart/enabled/deviantart_url');
		
		$whatsapp_switch = fw_get_db_settings_option('widget_social_media_whatsapp/whatsapp_switch');
		$whatsapp_url = fw_get_db_settings_option('widget_social_media_whatsapp/enabled/whatsapp_url');
		
		$snapchat_switch = fw_get_db_settings_option('widget_social_media_snapchat/snapchat_switch');
		$snapchat_url = fw_get_db_settings_option('widget_social_media_snapchat/enabled/snapchat_url');
		
		$blogger_switch = fw_get_db_settings_option('widget_social_media_blogger/blogger_switch');
		$blogger_url = fw_get_db_settings_option('widget_social_media_blogger/enabled/blogger_url');
		
		$wordpress_switch = fw_get_db_settings_option('widget_social_media_wordpress/wordpress_switch');
		$wordpress_url = fw_get_db_settings_option('widget_social_media_wordpress/enabled/wordpress_url');
		
		$amazon_switch = fw_get_db_settings_option('widget_social_media_amazon/amazon_switch');
		$amazon_url = fw_get_db_settings_option('widget_social_media_amazon/enabled/amazon_url');
		
		$appstore_switch = fw_get_db_settings_option('widget_social_media_appstore/appstore_switch');
		$appstore_url = fw_get_db_settings_option('widget_social_media_appstore/enabled/appstore_url');
		
		$paypal_switch = fw_get_db_settings_option('widget_social_media_paypal/paypal_switch');
		$paypal_url = fw_get_db_settings_option('widget_social_media_paypal/enabled/paypal_url');
		
		$myspace_switch = fw_get_db_settings_option('widget_social_media_myspace/myspace_switch');
		$myspace_url = fw_get_db_settings_option('widget_social_media_myspace/enabled/myspace_url');
		
		$dropbox_switch = fw_get_db_settings_option('widget_social_media_dropbox/dropbox_switch');
		$dropbox_url = fw_get_db_settings_option('widget_social_media_dropbox/enabled/dropbox_url');
		
		$windows8_switch = fw_get_db_settings_option('widget_social_media_windows8/windows8_switch');
		$windows8_url = fw_get_db_settings_option('widget_social_media_windows8/enabled/windows8_url');
		
		$pinterest_switch = fw_get_db_settings_option('widget_social_media_pinterest/pinterest_switch');
		$pinterest_url = fw_get_db_settings_option('widget_social_media_pinterest/enabled/pinterest_url');
		
		$soundcloud_switch = fw_get_db_settings_option('widget_social_media_soundcloud/soundcloud_switch');
		$soundcloud_url = fw_get_db_settings_option('widget_social_media_soundcloud/enabled/soundcloud_url');
		
		$google_drive_switch = fw_get_db_settings_option('widget_social_media_google_drive/google_drive_switch');
		$google_drive_url = fw_get_db_settings_option('widget_social_media_google_drive/enabled/google_drive_url');
		
		$android_switch = fw_get_db_settings_option('widget_social_media_android/android_switch');
		$android_url = fw_get_db_settings_option('widget_social_media_android/enabled/android_url');
		
		$behance_switch = fw_get_db_settings_option('widget_social_media_behance/behance_switch');
		$behance_url = fw_get_db_settings_option('widget_social_media_behance/enabled/behance_url');
		
		$instagram_switch = fw_get_db_settings_option('widget_social_media_instagram/instagram_switch');
		$instagram_url = fw_get_db_settings_option('widget_social_media_instagram/enabled/instagram_url');
		
		$ebay_switch = fw_get_db_settings_option('widget_social_media_ebay/ebay_switch');
		$ebay_url = fw_get_db_settings_option('widget_social_media_ebay/enabled/ebay_url');
		
		$google_plus_switch = fw_get_db_settings_option('widget_social_media_google_plus/google_plus_switch');
		$google_plus_url = fw_get_db_settings_option('widget_social_media_google_plus/enabled/google_plus_url');

		$github_switch = fw_get_db_settings_option('widget_social_media_github/github_switch');
		$github_url = fw_get_db_settings_option('widget_social_media_github/enabled/github_url');
		
		$stackoverflow_switch = fw_get_db_settings_option('widget_social_media_stackoverflow/stackoverflow_switch');
		$stackoverflow_url = fw_get_db_settings_option('widget_social_media_stackoverflow/enabled/stackoverflow_url');
		
		$spotify_switch = fw_get_db_settings_option('widget_social_media_spotify/spotify_switch');
		$spotify_url = fw_get_db_settings_option('widget_social_media_spotify/enabled/spotify_url');
		
		$stumbleupon_switch = fw_get_db_settings_option('widget_social_media_stumbleupon/stumbleupon_switch');
		$stumbleupon_url = fw_get_db_settings_option('widget_social_media_stumbleupon/enabled/stumbleupon_url');
		
		$visa_switch = fw_get_db_settings_option('widget_social_media_visa/visa_switch');
		$visa_url = fw_get_db_settings_option('widget_social_media_visa/enabled/visa_url');
		
		$mastercard_switch = fw_get_db_settings_option('widget_social_media_mastercard/mastercard_switch');
		$mastercard_url = fw_get_db_settings_option('widget_social_media_mastercard/enabled/mastercard_url');
		
		$amex_switch = fw_get_db_settings_option('widget_social_media_amex/amex_switch');
		$amex_url = fw_get_db_settings_option('widget_social_media_amex/enabled/amex_url');
		
		$ios_switch = fw_get_db_settings_option('widget_social_media_ios/ios_switch');
		$ios_url = fw_get_db_settings_option('widget_social_media_ios/enabled/ios_url');
		
		$osx_switch = fw_get_db_settings_option('widget_social_media_osx/osx_switch');
		$osx_url = fw_get_db_settings_option('widget_social_media_osx/enabled/osx_url');
		
		$evernote_switch = fw_get_db_settings_option('widget_social_media_evernote/evernote_switch');
		$evernote_url = fw_get_db_settings_option('widget_social_media_evernote/enabled/evernote_url');
		
		$yelp_switch = fw_get_db_settings_option('widget_social_media_yelp/yelp_switch');
		$yelp_url = fw_get_db_settings_option('widget_social_media_yelp/enabled/yelp_url');
		
		$yelp2_switch = fw_get_db_settings_option('widget_social_media_yelp2/yelp2_switch');
		$yelp2_url = fw_get_db_settings_option('widget_social_media_yelp2/enabled/yelp2_url');
		
		$medium_switch = fw_get_db_settings_option('widget_social_media_medium/medium_switch');
		$medium_url = fw_get_db_settings_option('widget_social_media_medium/enabled/medium_url');
		
		$slack_switch = fw_get_db_settings_option('widget_social_media_slack/slack_switch');
		$slack_url = fw_get_db_settings_option('widget_social_media_slack/enabled/slack_url');
		
		$vine_switch = fw_get_db_settings_option('widget_social_media_vine/vine_switch');
		$vine_url = fw_get_db_settings_option('widget_social_media_vine/enabled/vine_url');
		
		$edge_switch = fw_get_db_settings_option('widget_social_media_edge/edge_switch');
		$edge_url = fw_get_db_settings_option('widget_social_media_edge/enabled/edge_url');
		
		$outlook_switch = fw_get_db_settings_option('widget_social_media_outlook/outlook_switch');
		$outlook_url = fw_get_db_settings_option('widget_social_media_outlook/enabled/outlook_url');
		
		$pencilcase_switch = fw_get_db_settings_option('widget_social_media_pencilcase/pencilcase_switch');
		$pencilcase_url = fw_get_db_settings_option('widget_social_media_pencilcase/enabled/pencilcase_url');
		
		$play_switch = fw_get_db_settings_option('widget_social_media_play/play_switch');
		$play_url = fw_get_db_settings_option('widget_social_media_play/enabled/play_url');
		
		$icloud_switch = fw_get_db_settings_option('widget_social_media_icloud/icloud_switch');
		$icloud_url = fw_get_db_settings_option('widget_social_media_icloud/enabled/icloud_url');
		
		$forrst_switch_1 = fw_get_db_settings_option('widget_social_media_forrst_1/forrst_switch_1');
		$forrst_url_1 = fw_get_db_settings_option('widget_social_media_forrst_1/enabled/forrst_url_1');
		
		$dribbble_switch_1 = fw_get_db_settings_option('widget_social_media_dribbble_1/dribbble_switch_1');
		$dribbble_url_1 = fw_get_db_settings_option('widget_social_media_dribbble_1/enabled/dribbble_url_1');
		
		$twitter_switch_1 = fw_get_db_settings_option('widget_social_media_twitter_1/twitter_switch_1');
		$twitter_url_1 = fw_get_db_settings_option('widget_social_media_twitter_1/enabled/twitter_url_1');
		
		$flickr_switch_1 = fw_get_db_settings_option('widget_social_media_flickr_1/flickr_switch_1');
		$flickr_url_1 = fw_get_db_settings_option('widget_social_media_flickr_1/enabled/flickr_url_1');
		
		$twitter2_switch_1 = fw_get_db_settings_option('widget_social_media_twitter2_1/twitter2_switch_1');
		$twitter2_url_1 = fw_get_db_settings_option('widget_social_media_twitter2_1/enabled/twitter2_url_1');
		
		$facebook_switch_1 = fw_get_db_settings_option('widget_social_media_facebook_1/facebook_switch_1');
		$facebook_url_1 = fw_get_db_settings_option('widget_social_media_facebook_1/enabled/facebook_url_1');
		
		$skype_switch_1 = fw_get_db_settings_option('widget_social_media_skype_1/skype_switch_1');
		$skype_url_1 = fw_get_db_settings_option('widget_social_media_skype_1/enabled/skype_url_1');
		
		$digg_switch_1 = fw_get_db_settings_option('widget_social_media_digg_1/digg_switch_1');
		$digg_url_1 = fw_get_db_settings_option('widget_social_media_digg_1/enabled/digg_url_1');
		
		$google_switch_1 = fw_get_db_settings_option('widget_social_media_google_1/google_switch_1');
		$google_url_1 = fw_get_db_settings_option('widget_social_media_google_1/enabled/google_url_1');
		
		$html5_switch_1 = fw_get_db_settings_option('widget_social_media_html5_1/html5_switch_1');
		$html5_url_1 = fw_get_db_settings_option('widget_social_media_html5_1/enabled/html5_url_1');
		
		$linkedin_switch_1 = fw_get_db_settings_option('widget_social_media_linkedin_1/linkedin_switch_1');
		$linkedin_url_1 = fw_get_db_settings_option('widget_social_media_linkedin_1/enabled/linkedin_url_1');
		
		$lastfm_switch_1 = fw_get_db_settings_option('widget_social_media_lastfm_1/lastfm_switch_1');
		$lastfm_url_1 = fw_get_db_settings_option('widget_social_media_lastfm_1/enabled/lastfm_url_1');
		
		$vimeo_switch_1 = fw_get_db_settings_option('widget_social_media_vimeo_1/vimeo_switch_1');
		$vimeo_url_1 = fw_get_db_settings_option('widget_social_media_vimeo_1/enabled/vimeo_url_1');
		
		$yahoo_switch_1 = fw_get_db_settings_option('widget_social_media_yahoo_1/yahoo_switch_1');
		$yahoo_url_1 = fw_get_db_settings_option('widget_social_media_yahoo_1/enabled/yahoo_url_1');
		
		$tumblr_switch_1 = fw_get_db_settings_option('widget_social_media_tumblr_1/tumblr_switch_1');
		$tumblr_url_1 = fw_get_db_settings_option('widget_social_media_tumblr_1/enabled/tumblr_url_1');
		
		$apple_switch_1 = fw_get_db_settings_option('widget_social_media_apple_1/apple_switch_1');
		$apple_url_1 = fw_get_db_settings_option('widget_social_media_apple_1/enabled/apple_url_1');
		
		$windows_switch_1 = fw_get_db_settings_option('widget_social_media_windows_1/windows_switch_1');
		$windows_url_1 = fw_get_db_settings_option('widget_social_media_windows_1/enabled/windows_url_1');
		
		$youtube_switch_1 = fw_get_db_settings_option('widget_social_media_youtube_1/youtube_switch_1');
		$youtube_url_1 = fw_get_db_settings_option('widget_social_media_youtube_1/enabled/youtube_url_1');
		
		$delicious_switch_1 = fw_get_db_settings_option('widget_social_media_delicious_1/delicious_switch_1');
		$delicious_url_1 = fw_get_db_settings_option('widget_social_media_delicious_1/enabled/delicious_url_1');
		
		$rss_switch_1 = fw_get_db_settings_option('widget_social_media_rss_1/rss_switch_1');
		$rss_url_1 = fw_get_db_settings_option('widget_social_media_rss_1/enabled/rss_url_1');
		
		$picasa_switch_1 = fw_get_db_settings_option('widget_social_media_picasa_1/picasa_switch_1');
		$picasa_url_1 = fw_get_db_settings_option('widget_social_media_picasa_1/enabled/picasa_url_1');
		
		$deviantart_switch_1 = fw_get_db_settings_option('widget_social_media_deviantart_1/deviantart_switch_1');
		$deviantart_url_1 = fw_get_db_settings_option('widget_social_media_deviantart_1/enabled/deviantart_url_1');
		
		$whatsapp_switch_1 = fw_get_db_settings_option('widget_social_media_whatsapp_1/whatsapp_switch_1');
		$whatsapp_url_1 = fw_get_db_settings_option('widget_social_media_whatsapp_1/enabled/whatsapp_url_1');
		
		$snapchat_switch_1 = fw_get_db_settings_option('widget_social_media_snapchat_1/snapchat_switch_1');
		$snapchat_url_1 = fw_get_db_settings_option('widget_social_media_snapchat_1/enabled/snapchat_url_1');
		
		$blogger_switch_1 = fw_get_db_settings_option('widget_social_media_blogger_1/blogger_switch_1');
		$blogger_url_1 = fw_get_db_settings_option('widget_social_media_blogger_1/enabled/blogger_url_1');
		
		$wordpress_switch_1 = fw_get_db_settings_option('widget_social_media_wordpress_1/wordpress_switch_1');
		$wordpress_url_1 = fw_get_db_settings_option('widget_social_media_wordpress_1/enabled/wordpress_url_1');
		
		$amazon_switch_1 = fw_get_db_settings_option('widget_social_media_amazon_1/amazon_switch_1');
		$amazon_url_1 = fw_get_db_settings_option('widget_social_media_amazon_1/enabled/amazon_url_1');
		
		$appstore_switch_1 = fw_get_db_settings_option('widget_social_media_appstore_1/appstore_switch_1');
		$appstore_url_1 = fw_get_db_settings_option('widget_social_media_appstore_1/enabled/appstore_url_1');
		
		$paypal_switch_1 = fw_get_db_settings_option('widget_social_media_paypal_1/paypal_switch_1');
		$paypal_url_1 = fw_get_db_settings_option('widget_social_media_paypal_1/enabled/paypal_url_1');
		
		$myspace_switch_1 = fw_get_db_settings_option('widget_social_media_myspace_1/myspace_switch_1');
		$myspace_url_1 = fw_get_db_settings_option('widget_social_media_myspace_1/enabled/myspace_url_1');
		
		$dropbox_switch_1 = fw_get_db_settings_option('widget_social_media_dropbox_1/dropbox_switch_1');
		$dropbox_url_1 = fw_get_db_settings_option('widget_social_media_dropbox_1/enabled/dropbox_url_1');
		
		$windows8_switch_1 = fw_get_db_settings_option('widget_social_media_windows8_1/windows8_switch_1');
		$windows8_url_1 = fw_get_db_settings_option('widget_social_media_windows8_1/enabled/windows8_url_1');
		
		$pinterest_switch_1 = fw_get_db_settings_option('widget_social_media_pinterest_1/pinterest_switch_1');
		$pinterest_url_1 = fw_get_db_settings_option('widget_social_media_pinterest_1/enabled/pinterest_url_1');
		
		$soundcloud_switch_1 = fw_get_db_settings_option('widget_social_media_soundcloud_1/soundcloud_switch_1');
		$soundcloud_url_1 = fw_get_db_settings_option('widget_social_media_soundcloud_1/enabled/soundcloud_url_1');
		
		$google_drive_switch_1 = fw_get_db_settings_option('widget_social_media_google_drive_1/google_drive_switch_1');
		$google_drive_url_1 = fw_get_db_settings_option('widget_social_media_google_drive_1/enabled/google_drive_url_1');
		
		$android_switch_1 = fw_get_db_settings_option('widget_social_media_android_1/android_switch_1');
		$android_url_1 = fw_get_db_settings_option('widget_social_media_android_1/enabled/android_url_1');
		
		$behance_switch_1 = fw_get_db_settings_option('widget_social_media_behance_1/behance_switch_1');
		$behance_url_1 = fw_get_db_settings_option('widget_social_media_behance_1/enabled/behance_url_1');
		
		$instagram_switch_1 = fw_get_db_settings_option('widget_social_media_instagram_1/instagram_switch_1');
		$instagram_url_1 = fw_get_db_settings_option('widget_social_media_instagram_1/enabled/instagram_url_1');
		
		$ebay_switch_1 = fw_get_db_settings_option('widget_social_media_ebay_1/ebay_switch_1');
		$ebay_url_1 = fw_get_db_settings_option('widget_social_media_ebay_1/enabled/ebay_url_1');
		
		$google_plus_switch_1 = fw_get_db_settings_option('widget_social_media_google_plus_1/google_plus_switch_1');
		$google_plus_url_1 = fw_get_db_settings_option('widget_social_media_google_plus_1/enabled/google_plus_url_1');

		$github_switch_1 = fw_get_db_settings_option('widget_social_media_github_1/github_switch_1');
		$github_url_1 = fw_get_db_settings_option('widget_social_media_github_1/enabled/github_url_1');
		
		$stackoverflow_switch_1 = fw_get_db_settings_option('widget_social_media_stackoverflow_1/stackoverflow_switch_1');
		$stackoverflow_url_1 = fw_get_db_settings_option('widget_social_media_stackoverflow_1/enabled/stackoverflow_url_1');
		
		$spotify_switch_1 = fw_get_db_settings_option('widget_social_media_spotify_1/spotify_switch_1');
		$spotify_url_1 = fw_get_db_settings_option('widget_social_media_spotify_1/enabled/spotify_url_1');
		
		$stumbleupon_switch_1 = fw_get_db_settings_option('widget_social_media_stumbleupon_1/stumbleupon_switch_1');
		$stumbleupon_url_1 = fw_get_db_settings_option('widget_social_media_stumbleupon_1/enabled/stumbleupon_url_1');
		
		$visa_switch_1 = fw_get_db_settings_option('widget_social_media_visa_1/visa_switch_1');
		$visa_url_1 = fw_get_db_settings_option('widget_social_media_visa_1/enabled/visa_url_1');
		
		$mastercard_switch_1 = fw_get_db_settings_option('widget_social_media_mastercard_1/mastercard_switch_1');
		$mastercard_url_1 = fw_get_db_settings_option('widget_social_media_mastercard_1/enabled/mastercard_url_1');
		
		$amex_switch_1 = fw_get_db_settings_option('widget_social_media_amex_1/amex_switch_1');
		$amex_url_1 = fw_get_db_settings_option('widget_social_media_amex_1/enabled/amex_url_1');
		
		$ios_switch_1 = fw_get_db_settings_option('widget_social_media_ios_1/ios_switch_1');
		$ios_url_1 = fw_get_db_settings_option('widget_social_media_ios_1/enabled/ios_url_1');
		
		$osx_switch_1 = fw_get_db_settings_option('widget_social_media_osx_1/osx_switch_1');
		$osx_url_1 = fw_get_db_settings_option('widget_social_media_osx_1/enabled/osx_url_1');
		
		$evernote_switch_1 = fw_get_db_settings_option('widget_social_media_evernote_1/evernote_switch_1');
		$evernote_url_1 = fw_get_db_settings_option('widget_social_media_evernote_1/enabled/evernote_url_1');
		
		$yelp_switch_1 = fw_get_db_settings_option('widget_social_media_yelp_1/yelp_switch_1');
		$yelp_url_1 = fw_get_db_settings_option('widget_social_media_yelp_1/enabled/yelp_url_1');
		
		$yelp2_switch_1 = fw_get_db_settings_option('widget_social_media_yelp2_1/yelp2_switch_1');
		$yelp2_url_1 = fw_get_db_settings_option('widget_social_media_yelp2_1/enabled/yelp2_url_1');
		
		$medium_switch_1 = fw_get_db_settings_option('widget_social_media_medium_1/medium_switch_1');
		$medium_url_1 = fw_get_db_settings_option('widget_social_media_medium_1/enabled/medium_url_1');
		
		$slack_switch_1 = fw_get_db_settings_option('widget_social_media_slack_1/slack_switch_1');
		$slack_url_1 = fw_get_db_settings_option('widget_social_media_slack_1/enabled/slack_url_1');
		
		$vine_switch_1 = fw_get_db_settings_option('widget_social_media_vine_1/vine_switch_1');
		$vine_url_1 = fw_get_db_settings_option('widget_social_media_vine_1/enabled/vine_url_1');
		
		$edge_switch_1 = fw_get_db_settings_option('widget_social_media_edge_1/edge_switch_1');
		$edge_url_1 = fw_get_db_settings_option('widget_social_media_edge_1/enabled/edge_url_1');
		
		$outlook_switch_1 = fw_get_db_settings_option('widget_social_media_outlook_1/outlook_switch_1');
		$outlook_url_1 = fw_get_db_settings_option('widget_social_media_outlook_1/enabled/outlook_url_1');
		
		$pencilcase_switch_1 = fw_get_db_settings_option('widget_social_media_pencilcase_1/pencilcase_switch_1');
		$pencilcase_url_1 = fw_get_db_settings_option('widget_social_media_pencilcase_1/enabled/pencilcase_url_1');
		
		$play_switch_1 = fw_get_db_settings_option('widget_social_media_play_1/play_switch_1');
		$play_url_1 = fw_get_db_settings_option('widget_social_media_play_1/enabled/play_url_1');
		
		$icloud_switch_1 = fw_get_db_settings_option('widget_social_media_icloud_1/icloud_switch_1');
		$icloud_url_1 = fw_get_db_settings_option('widget_social_media_icloud_1/enabled/icloud_url_1');
		
		$social_media_btn_visibility = fw_get_db_settings_option('widget_social_media_btn_visibility');
		
	}
  // CUSTOM:
  $widget_social_media_type = 'variant_1';
  $facebook_switch = $instagram_switch = $twitter_switch = $youtube_switch = 'enabled';
  $facebook_url = 'http://facebook.com/tickcopy';
  $youtube_url = 'https://www.youtube.com/channel/UCaDKTYig1gFGVrS9mI1NQWg';
  $instagram_url = 'https://www.instagram.com/tickcopy';
  $twitter_url = 'https://twitter.com/tickcopy';
?>
<style>
  #footer .tagcloud a, #footer .widget ul > li > a,
  #footer .tagcloud a, #footer .widget ul > li > a:hover  {
    background: transparent !important;
    color: white !important;
    border: none;
  }
  #footer .tagcloud a, #footer .widget ul > li > a:hover  {
    color: rgba(222,0,46,1) !important;
  }
</style>

<?php if(($widget_social_media_type=='enabled')||($forrst_switch=='enabled')||($forrst_url=='enabled')||($dribbble_switch=='enabled')||($dribbble_url=='enabled')||($twitter_switch=='enabled')||($twitter_url=='enabled')||($flickr_switch=='enabled')||($flickr_url=='enabled')||($twitter2_switch=='enabled')||($twitter2_url=='enabled')||($facebook_switch=='enabled')||($facebook_url=='enabled')||($skype_switch=='enabled')||($skype_url=='enabled')||($digg_switch=='enabled')||($digg_url=='enabled')||($google_switch=='enabled')||($google_url=='enabled')||($html5_switch=='enabled')||($html5_url=='enabled')||($linkedin_switch=='enabled')||($linkedin_url=='enabled')||($lastfm_switch=='enabled')||($lastfm_url=='enabled')||($vimeo_switch=='enabled')||($vimeo_url=='enabled')||($yahoo_switch=='enabled')||($yahoo_url=='enabled')||($tumblr_switch=='enabled')||($tumblr_url=='enabled')||($apple_switch=='enabled')||($apple_url=='enabled')||($windows_switch=='enabled')||($windows_url=='enabled')||($youtube_switch=='enabled')||($youtube_url=='enabled')||($delicious_switch=='enabled')||($delicious_url=='enabled')||($rss_switch=='enabled')||($rss_url=='enabled')||($picasa_switch=='enabled')||($picasa_url=='enabled')||($deviantart_switch=='enabled')||($deviantart_url=='enabled')||($whatsapp_switch=='enabled')||($whatsapp_url=='enabled')||($snapchat_switch=='enabled')||($snapchat_url=='enabled')||($blogger_switch=='enabled')||($blogger_url=='enabled')||($wordpress_switch=='enabled')||($wordpress_url=='enabled')||($amazon_switch=='enabled')||($amazon_url=='enabled')||($appstore_switch=='enabled')||($appstore_url=='enabled')||($paypal_switch=='enabled')||($paypal_url=='enabled')||($myspace_switch=='enabled')||($myspace_url=='enabled')||($dropbox_switch=='enabled')||($dropbox_url=='enabled')||($windows8_switch=='enabled')||($windows8_url=='enabled')||($pinterest_switch=='enabled')||($pinterest_url=='enabled')||($soundcloud_switch=='enabled')||($soundcloud_url=='enabled')||($google_drive_switch=='enabled')||($google_drive_url=='enabled')||($android_switch=='enabled')||($android_url=='enabled')||($behance_switch=='enabled')||($behance_url=='enabled')||($instagram_switch=='enabled')||($instagram_url=='enabled')||($ebay_switch=='enabled')||($ebay_url=='enabled')||($google_plus_switch=='enabled')||($google_plus_url=='enabled')||($github_switch=='enabled')||($github_url=='enabled')||($stackoverflow_switch=='enabled')||($stackoverflow_url=='enabled')||($spotify_switch=='enabled')||($spotify_url=='enabled')||($stumbleupon_switch=='enabled')||($stumbleupon_url=='enabled')||($visa_switch=='enabled')||($visa_url=='enabled')||($mastercard_switch=='enabled')||($mastercard_url=='enabled')||($amex_switch=='enabled')||($amex_url=='enabled')||($ios_switch=='enabled')||($ios_url=='enabled')||($osx_switch=='enabled')||($osx_url=='enabled')||($evernote_switch=='enabled')||($evernote_url=='enabled')||($yelp_switch=='enabled')||($yelp_url=='enabled')||($yelp2_switch=='enabled')||($yelp2_url=='enabled')||($medium_switch=='enabled')||($medium_url=='enabled')||($slack_switch=='enabled')||($slack_url=='enabled')||($vine_switch=='enabled')||($vine_url=='enabled')||($edge_switch=='enabled')||($edge_url=='enabled')||($outlook_switch=='enabled')||($outlook_url=='enabled')||($pencilcase_switch=='enabled')||($pencilcase_url=='enabled')||($play_switch=='enabled')||($play_url=='enabled')||($icloud_switch=='enabled')||($icloud_url=='enabled')||($forrst_switch_1=='enabled')||($forrst_url_1=='enabled')||($dribbble_switch_1=='enabled')||($dribbble_url_1=='enabled')|| ($twitter_switch_1=='enabled')||($twitter_url_1=='enabled')||($flickr_switch_1=='enabled')||($flickr_url_1=='enabled')||($twitter2_switch_1=='enabled')||($twitter2_url_1=='enabled')||($facebook_switch_1=='enabled')||($facebook_url_1=='enabled')||($skype_switch_1=='enabled')||($skype_url_1=='enabled')||($digg_switch_1=='enabled')||($digg_url_1=='enabled')||($google_switch_1=='enabled')||($google_url_1=='enabled')||($html5_switch_1=='enabled')||($html5_url_1=='enabled')||($linkedin_switch_1=='enabled')||($linkedin_url_1=='enabled')||($lastfm_switch_1=='enabled')||($lastfm_url_1=='enabled')||($vimeo_switch_1=='enabled')||($vimeo_url_1=='enabled')||($yahoo_switch_1=='enabled')||($yahoo_url_1=='enabled')||($tumblr_switch_1=='enabled')||($tumblr_url_1=='enabled')||($apple_switch_1=='enabled')||($apple_url_1=='enabled')||($windows_switch_1=='enabled')||($windows_url_1=='enabled')||($youtube_switch_1=='enabled')||($youtube_url_1=='enabled')||($delicious_switch_1=='enabled')||($delicious_url_1=='enabled')||($rss_switch_1=='enabled')||($rss_url_1=='enabled')||($picasa_switch_1=='enabled')||($picasa_url_1=='enabled')||($deviantart_switch_1=='enabled')||($deviantart_url_1=='enabled')||($whatsapp_switch_1=='enabled')||($whatsapp_url_1=='enabled')||($snapchat_switch_1=='enabled')||($snapchat_url_1=='enabled')||($blogger_switch_1=='enabled')||($blogger_url_1=='enabled')||($wordpress_switch_1=='enabled')||($wordpress_url_1=='enabled')||($amazon_switch_1=='enabled')||($amazon_url_1=='enabled')||($appstore_switch_1=='enabled')||($appstore_url_1=='enabled')||($paypal_switch_1=='enabled')||($paypal_url_1=='enabled')||($myspace_switch_1=='enabled')||($myspace_url_1=='enabled')||($dropbox_switch_1=='enabled')||($dropbox_url_1=='enabled')||($windows8_switch_1=='enabled')||($windows8_url_1=='enabled')||($pinterest_switch_1=='enabled')||($pinterest_url_1=='enabled')||($soundcloud_switch_1=='enabled')||($soundcloud_url_1=='enabled')||($google_drive_switch_1=='enabled')||($google_drive_url_1=='enabled')||($android_switch_1=='enabled')||($android_url_1=='enabled')||($behance_switch_1=='enabled')||($behance_url_1=='enabled')||($instagram_switch_1=='enabled')||($instagram_url_1=='enabled')||($ebay_switch_1=='enabled')||($ebay_url_1=='enabled')||($google_plus_switch_1=='enabled')||($google_plus_url_1=='enabled')||($github_switch_1=='enabled')||($github_url_1=='enabled')||($stackoverflow_switch_1=='enabled')||($stackoverflow_url_1=='enabled')||($spotify_switch_1=='enabled')||($spotify_url_1=='enabled')||($stumbleupon_switch_1=='enabled')||($stumbleupon_url_1=='enabled')||($visa_switch_1=='enabled')||($visa_url_1=='enabled')||($mastercard_switch_1=='enabled')||($mastercard_url_1=='enabled')||($amex_switch_1=='enabled')||($amex_url_1=='enabled')||($ios_switch_1=='enabled')||($ios_url_1=='enabled')||($osx_switch_1=='enabled')||($osx_url_1=='enabled')||($evernote_switch_1=='enabled')||($evernote_url_1=='enabled')||($yelp_switch_1=='enabled')||($yelp_url_1=='enabled')||($yelp2_switch_1=='enabled')||($yelp2_url_1=='enabled')||($medium_switch_1=='enabled')||($medium_url_1=='enabled')||($slack_switch_1=='enabled')||($slack_url_1=='enabled')||($vine_switch_1=='enabled')||($vine_url_1=='enabled')||($edge_switch_1=='enabled')||($edge_url_1=='enabled')||($outlook_switch_1=='enabled')||($outlook_url_1=='enabled')||($pencilcase_switch_1=='enabled')||($pencilcase_url_1=='enabled')||($play_switch_1=='enabled')||($play_url_1=='enabled')||($icloud_switch_1=='enabled')||($icloud_url_1=='enabled')||($social_media_btn_visibility=='enabled')
){?>

		<div class="social-container">
			<!-- <div class="social-icons-container<?php if($widget_social_media_type!=''){?> social-icons-container-<?php echo esc_attr($widget_social_media_type);?><?php }?>"> -->
      <div class="social-icons-container social-icons-container-variant_1">
				<ul>
					...
					<?php if($twitter_switch=='enabled'){?><li><a target="_blank" href="<?php if($twitter_url){ echo esc_url($twitter_url); }?>"><i class="social-icon social-icon-03-twitter"></i><span class="tooltip-text tooltip-container"><span>Twitter</span></span><span class="bg-overlay"></span></a></li><?php }?>
					...
					<?php if($facebook_switch=='enabled'){?><li><a  target="_blank" href="<?php if($facebook_url){ echo esc_url($facebook_url); }?>"><i class="social-icon social-icon-06-facebook"></i><span class="tooltip-text tooltip-container"><span>Facebook</span></span><span class="bg-overlay"></span></a></li><?php }?>
					...
					<?php if($youtube_switch=='enabled'){?><li><a  target="_blank" href="<?php if($youtube_url){ echo esc_url($youtube_url); }?>"><i class="social-icon social-icon-18-youtube"></i><span class="tooltip-text tooltip-container"><span>Youtube</span></span><span class="bg-overlay"></span></a></li><?php }?>
					...
					<?php if($instagram_switch=='enabled'){?><li><a target="_blank" href="<?php if($instagram_url){ echo esc_url($instagram_url); }?>"><i class="social-icon social-icon-38-instagram"></i><span class="tooltip-text tooltip-container"><span>Instagram</span></span><span class="bg-overlay"></span></a></li><?php }?>
					...
					<?php if($twitter_switch_1=='enabled'){?><li><a  target="_blank" href="<?php if($twitter_url_1){ echo esc_url($twitter_url_1); }?>"><i class="social-icon social-icon-03-twitter-1"></i><span class="tooltip-text tooltip-container"><span>Twitter</span></span><span class="bg-overlay"></span></a></li><?php }?>
