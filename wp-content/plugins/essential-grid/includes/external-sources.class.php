    ...
    */
	...
	public function get_public_photos($search_user_id,$count,$orig_image){
		if(!empty($search_user_id)){
			...
			$url = 'https://instagram.com/graphql/query/?query_id=17888483320059182&id='.$search_user_id.'&first='.$count;
			...
			$count = $this->instagram_output_array($rsp->data->user->edge_owner_to_timeline_media->edges,$count,$search_user_id,$orig_image);

			if(!$rsp->data->user->edge_owner_to_timeline_media->count){
